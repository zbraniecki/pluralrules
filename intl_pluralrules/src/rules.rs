...
fn fmod(op: PluralOperands, m: isize, v: isize) -> bool {
    op.i % m == v && op.f == 0
}
pub fn get_pr(lang: &str) -> PluralRule {
    match lang {
        ...
        "pl" => |po| {
            if (po.v == 0 && matches!(po.i % 10, 2..=4) && po.f == 0
                && matches!(po.i % 100, 12..=14) && po.f == 0)
            {
                PluralCategory::FEW
            } else if (po.i == 1 && po.v == 0) {
                PluralCategory::ONE
            } else if (po.v == 0 && po.i != 1 && matches!(po.i % 10, 0..=1) && po.f == 0)
                || (po.v == 0 && matches!(po.i % 10, 5..=9) && po.f == 0)
                || (po.v == 0 && matches!(po.i % 100, 12..=14) && po.f == 0)
            {
                PluralCategory::MANY
            } else {
                PluralCategory::OTHER
        ...
        "mo" => |po| {
            if (po.v != 0) || (po.n == 0)
                || (po.n != 1 && matches!(po.i % 100, 1..=19) && po.f == 0)
            {
                PluralCategory::FEW
            } else if (po.i == 1 && po.v == 0) {
                PluralCategory::ONE
        ...
        "sk" => |po| {
            if (matches!(po.i, 2..=4) && po.f == 0 && po.v == 0) {
                PluralCategory::FEW
            } else if (po.v != 0) {
                PluralCategory::MANY
            } else if (po.i == 1 && po.v == 0) {
        ...
        "hsb" => |po| {
            if (po.v == 0 && po.i % 100 == 1) || (po.f % 100 == 1) {
                PluralCategory::ONE
            } else if (po.v == 0 && matches!(po.i % 100, 3..=4) && po.f == 0)
                || (matches!(po.f % 100, 3..=4) && po.f == 0)
            {
                PluralCategory::FEW
        ...
        "prg" => |po| {
                ...
                || (po.v != 2 && po.f % 10 == 1)
            {
                ...
                || (po.v == 2 && matches!(po.f % 100, 11..=19) && po.f == 0)
            {
                PluralCategory::ZERO
            } else {
                PluralCategory::OTHER
        ...
        "cs" => |po| {
            if (po.i == 1 && po.v == 0) {
                PluralCategory::ONE
            } else if (matches!(po.i, 2..=4) && po.f == 0 && po.v == 0) {
                PluralCategory::FEW
            } else if (po.v != 0) {
                PluralCategory::MANY
            } else {
        ...
        "bs" => |po| {
            ...
            {
                PluralCategory::ONE
            } else if (po.v == 0 && matches!(po.i % 10, 2..=4) && po.f == 0
                && matches!(po.i % 100, 12..=14) && po.f == 0)
                || (matches!(po.f % 10, 2..=4) && po.f == 0 && matches!(po.f % 100, 12..=14)
                    && po.f == 0)
            {
                PluralCategory::FEW
            } else {
        ...
        "mt" => |po| {
            if (matches!(po.i % 100, 11..=19) && po.f == 0) {
                PluralCategory::MANY
            } else if (po.n == 0) || (matches!(po.i % 100, 2..=10) && po.f == 0) {
                PluralCategory::FEW
            } else if (po.n == 1) {
                PluralCategory::ONE
            } else {
        ...
        "br" => |po| {
            if ((po.i % 10 == 9 || matches!(po.i % 10, 3..=4) && po.f == 0)
        ...
        "sl" => |po| {
            if (po.v == 0 && matches!(po.i % 100, 3..=4) && po.f == 0) || (po.v != 0) {
                PluralCategory::FEW
        ...
        "uk" => |po| {
            if (po.v == 0 && po.i % 10 == 1 && po.i % 100 != 11) {
                ...
                || (po.v == 0 && matches!(po.i % 10, 5..=9) && po.f == 0)
                || (po.v == 0 && matches!(po.i % 100, 11..=14) && po.f == 0)
            {
                PluralCategory::MANY
            } else if (po.v == 0 && matches!(po.i % 10, 2..=4) && po.f == 0
                && matches!(po.i % 100, 12..=14) && po.f == 0)
