...
pub fn get_pr(lang_code: &str, pr_type: PluralRuleType) -> Result<PluralRule, ()> {
    match pr_type {
        PluralRuleType::CARDINAL => match lang_code {
            "af" => Ok(|po| {
                if (po.n == 1.0) {
                    PluralCategory::ONE
                } else {
        ...
        PluralRuleType::ORDINAL => match lang_code {
            "af" => Ok(|po| PluralCategory::OTHER),
            "am" => Ok(|po| PluralCategory::OTHER),
            "ar" => Ok(|po| PluralCategory::OTHER),
            "as" => Ok(|po| {
                if (po.n == 4.0) {
                    PluralCategory::FEW
                } else if (po.n == 6.0) {
            ...
            "ce" => Ok(|po| PluralCategory::OTHER),
            "cs" => Ok(|po| PluralCategory::OTHER),
            "cy" => Ok(|po| {
            ...
            "da" => Ok(|po| PluralCategory::OTHER),
            "de" => Ok(|po| PluralCategory::OTHER),
            "dsb" => Ok(|po| PluralCategory::OTHER),
            "el" => Ok(|po| PluralCategory::OTHER),
            "en" => Ok(|po| {
            ...
            "es" => Ok(|po| PluralCategory::OTHER),
            "et" => Ok(|po| PluralCategory::OTHER),
            "eu" => Ok(|po| PluralCategory::OTHER),
            "fa" => Ok(|po| PluralCategory::OTHER),
            "fi" => Ok(|po| PluralCategory::OTHER),
            "fil" => Ok(|po| {
                if (po.n == 1.0) {
                    PluralCategory::ONE
                } else {
            ...
            "gl" => Ok(|po| PluralCategory::OTHER),
            "gsw" => Ok(|po| PluralCategory::OTHER),
            "gu" => Ok(|po| {
                if (po.n == 4.0) {
                    PluralCategory::FEW
                } else if (po.n == 6.0) {
            ...
            "hr" => Ok(|po| PluralCategory::OTHER),
            "hsb" => Ok(|po| PluralCategory::OTHER),
            "hu" => Ok(|po| {
            ...
            "km" => Ok(|po| PluralCategory::OTHER),
            "kn" => Ok(|po| PluralCategory::OTHER),
            "ko" => Ok(|po| PluralCategory::OTHER),
            "ky" => Ok(|po| PluralCategory::OTHER),
            "lo" => Ok(|po| {
                if (po.n == 1.0) {
                    PluralCategory::ONE
                } else {
            ...
            "lt" => Ok(|po| PluralCategory::OTHER),
            "lv" => Ok(|po| PluralCategory::OTHER),
            "mk" => Ok(|po| {
            ...
            "ml" => Ok(|po| PluralCategory::OTHER),
            "mn" => Ok(|po| PluralCategory::OTHER),
            "mo" => Ok(|po| {
                if (po.n == 1.0) {
                    PluralCategory::ONE
                } else {
            ...
            "pa" => Ok(|po| PluralCategory::OTHER),
            "pl" => Ok(|po| PluralCategory::OTHER),
            "prg" => Ok(|po| PluralCategory::OTHER),
            "ps" => Ok(|po| PluralCategory::OTHER),
            "pt" => Ok(|po| PluralCategory::OTHER),
            "ro" => Ok(|po| {
                if (po.n == 1.0) {
                    PluralCategory::ONE
                } else {
            ...
            "sd" => Ok(|po| PluralCategory::OTHER),
            "sh" => Ok(|po| PluralCategory::OTHER),
            "si" => Ok(|po| PluralCategory::OTHER),
            "sk" => Ok(|po| PluralCategory::OTHER),
            "sl" => Ok(|po| PluralCategory::OTHER),
            "sq" => Ok(|po| {
            ...
            "sw" => Ok(|po| PluralCategory::OTHER),
            "ta" => Ok(|po| PluralCategory::OTHER),
            "te" => Ok(|po| PluralCategory::OTHER),
            "th" => Ok(|po| PluralCategory::OTHER),
            "tk" => Ok(|po| {
            ...
            "ur" => Ok(|po| PluralCategory::OTHER),
            "uz" => Ok(|po| PluralCategory::OTHER),
            "vi" => Ok(|po| {
                if (po.n == 1.0) {
                    PluralCategory::ONE
                } else {
