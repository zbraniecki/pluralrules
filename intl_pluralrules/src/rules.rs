...
pub fn get_pr(lang: &str) -> PluralRule {
    match lang {
        ...
        "pl" => |po| {
            if (po.v == 0 && po.i != 1 && matches!(po.i % 10, 0..=1) && po.f == 0)
        ...
        "sl" => |po| {
            if (po.v == 0 && po.i % 100 == 2) {
                ...
                PluralCategory::ONE
            } else if (po.v == 0 && matches!(po.i % 100, 3..=4) && po.f == 0) || (po.v != 0) {
                PluralCategory::FEW
            } else {
                PluralCategory::OTHER
            }
        ...
        "dsb" => |po| {
            if (po.v == 0 && matches!(po.i % 100, 3..=4) && po.f == 0)
        ...
        "br" => |po| {
            if (po.i % 10 == 2 && po.i % 100 != 12 && po.i % 100 != 72 && po.i % 100 != 92) {
                PluralCategory::TWO
        ...
        "mt" => |po| {
            if (po.n == 0.0) || (matches!(po.i % 100, 2..=10) && po.f == 0) {
                PluralCategory::FEW
            } else if (po.n == 1.0) {
                PluralCategory::ONE
